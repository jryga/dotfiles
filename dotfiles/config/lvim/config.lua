...
lvim.colorscheme = "Atelier_SeasideDark"
...
--   pattern = { "*.json", "*.jsonc" },
--   -- enable wrap mode fojr json files only
...
lvim.plugins = {
  {
    ...
    -- config = function()
    --   lvim.colorscheme("Atelier_SeasideDark")
    --   vim.highlight.create('VertSplit', { guifg = "fg", guibg = "bg" }, false)
    -- end,
  },
  {
...
-- https://docs.ansible.com/ansible/latest/user_guide/vault.html#vim
if vim.fn.expand('~/.ansible/tmp') == vim.fn.expand('%:p:h:h') then
